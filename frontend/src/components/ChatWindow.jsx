        ...
        >
          ...
          {isStreaming && streamingMessage && (
            <div className="flex flex-col max-w-[80%] self-start items-start w-full animate-bubble-entry" id="msg-streaming">
              ...
              <span className="text-[10px] text-butter-300 font-light mt-1.5 pl-1 font-sans">
                Maya
              </span>
            </div>
          )}
          ...
          {isStreaming && !streamingMessage && (
            <div className="flex flex-col self-start items-start w-full" id="msg-thinking">
              ...
              <span className="text-[10px] text-butter-300 font-light mt-1.5 pl-1 font-sans select-none">
                Maya
              </span>
            </div>
          )}
